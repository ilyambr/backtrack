...
- [obs-source-record](https://github.com/ilyambr/obs-source-record) (fork): OBS
  plugin, records/replays individual sources via a filter.
- [obs-replay-slider](https://github.com/ilyambr/obs-replay-slider): OBS
  plugin, a dock for managing source-record replay buffers.
...
along the way. But the code itself is substantially AI-written; 
obs-replay-slider and additions to obs-source-record were developed in the same way.
